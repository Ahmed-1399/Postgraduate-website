...
<body>
	...
	<!-- End header -->
            ...
            <h1 class="login_title"> <strong> PLEASE, LOGIN AS AN ADMINISTRATOR</strong></h1>
             <br>
                      <form action="" role="form" class="form-horizontal" method="post">
                          ...
                          <br>
							<div class="row">							
								<div class="col-sm-10">
									<button onclick="location.href='adminstration.php'"type="submit" class="btn btn-light-me" name="login" > 
										Login
									</button>
                                    
									<button onclick="location.href='admin_login.html'"  type="button" class="btn btn-light-me2">
										Cancel</button>
								</div>
							</div>
						</form>
